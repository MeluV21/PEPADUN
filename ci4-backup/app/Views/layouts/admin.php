...
<head>
    ...
    <title><?= esc($title ?? 'Pepadun Console') ?> - PEPADUN</title>
                ...
                <div class="container-1200">
                    ...
                    <div class="top-navbar-panel">
                        <div class="top-navbar-left">
                            <h2 style="font-size: 1.35rem; font-weight: 700; color: var(--primary); margin: 0; line-height: 1.2;"><?= esc($title ?? 'Monitoring Keterbukaan Informasi Publik') ?></h2>
