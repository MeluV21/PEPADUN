                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <div class="btn-group" style="justify-content: flex-end;">
                            <button class="btn btn-secondary btn-sm" onclick="openEditModal(<?= esc($user['id']) ?>, '<?= addslashes(esc($user['fullname'])) ?>', '<?= addslashes(esc($user['username'])) ?>', '<?= addslashes(esc($user['role'])) ?>')">
