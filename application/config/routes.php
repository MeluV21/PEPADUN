...
$route['monitoring/create'] = 'monitoring/create';
$route['monitoring/store'] = 'monitoring/store';
$route['monitoring/edit/(:num)'] = 'monitoring/edit/$1';
$route['monitoring/update/(:num)'] = 'monitoring/update/$1';
$route['monitoring/delete/(:num)'] = 'monitoring/delete/$1';
