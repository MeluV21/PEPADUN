...
|
*/
$config['base_url'] = getenv('app.baseURL') ? str_replace('public/', '', getenv('app.baseURL')) : 'http://localhost/PEPADUN/';
...
|
*/
$config['encryption_key'] = getenv('encryption.key') ?: 'PEPADUN_DEFAULT_KEY_1234567890_CI3';
